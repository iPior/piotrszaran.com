...
SpotiDash is a personalized music dashboard that lets signed-in Spotify users view their top tracks, top artists, recent listening activity, and newly released music in one interface. I built the full application in Next.js and TypeScript as a deeper step into the React ecosystem.
