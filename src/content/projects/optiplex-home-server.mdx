...
stack: ["Debian", "Caddy", "Cloudflare", "Tailscale", "Docker"]
...
- A shared PostgreSQL instance with pgAdmin and Adminer for database management, so the apps I plan to host can use one central database rather than each bundling its own SQLite file.
