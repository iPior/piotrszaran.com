...
stack: ["Raspberry Pi", "Docker", "Cloudflare", "Nginx", "Tailscale"]
blogSlug: "jellyfin"
featured: true
hidden: false
---
...
- Tailscale provides a private mesh VPN between my devices, so I can securely access and administer the stack remotely without opening additional ports on my home network.
